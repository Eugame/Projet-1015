...
#define QT_MOC_LITERAL(ofs, len) \
    uint(offsetof(qt_meta_stringdata_Chess_t, stringdata0) + ofs), len 
static const qt_meta_stringdata_Chess_t qt_meta_stringdata_Chess = {
    {
QT_MOC_LITERAL(0, 5) // "Chess"
...
const QMetaObject Chess::staticMetaObject = { {
    ...
    qt_meta_stringdata_Chess.offsetsAndSize,
    qt_meta_data_Chess,
    qt_static_metacall,
    nullptr,
qt_incomplete_metaTypeArray<qt_meta_stringdata_Chess_t
